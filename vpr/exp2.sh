...
#./vpr ~/vtr-verilog-to-routing/vtr_flow/arch/test/mux_unspecified.xml ~/vtr-verilog-to-routing/vtr_flow/benchmarks/vtr_benchmarks_blif/ch_intrinsics.blif --route_chan_width 300; cp vpr_stdout.log mux_unspecified/mux_10.log;
...
#./vpr ~/vtr-verilog-to-routing/vtr_flow/arch/test/tri_unspecified.xml ~/vtr-verilog-to-routing/vtr_flow/benchmarks/blif/apex4.blif --route_chan_width 300; cp vpr_stdout.log tri_unspecified/tri_2.log;
...
#./vpr ~/vtr-verilog-to-routing/vtr_flow/arch/test/tri_specified.xml ~/vtr-verilog-to-routing/vtr_flow/benchmarks/blif/apex4.blif --route_chan_width 300; cp vpr_stdout.log tri_specified/tri_2.log;
